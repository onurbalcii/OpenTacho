...
- **Голосовые объявления**: короткие фразы офлайн-голосом Windows («до конца вождения 15 минут», «перерыв завершён» …), на пяти языках; отдельные регуляторы громкости для сигнала и объявлений.
